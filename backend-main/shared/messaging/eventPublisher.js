// shared/messaging/eventPublisher.js - CORRIGIDO
const redisService = require("./redisService"); // ✅ CORRETO - arquivo existe
...
class EventPublisher {
  ...
  async publishEvent(eventType, data, options = {}) {
    try {
      ...
      const queue = config.getQueue(eventType, options.service); // ✅ Adicionar service
